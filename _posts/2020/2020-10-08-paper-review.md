...
### 모델 전체 구조
![](/img/in-post/2020/2020-09-25/train_process.png)
...
![](/img/in-post/2020/2020-09-25/audio_preprocess.png)
...
<center>$s_{t, i} = w^{T}\tanh\left(W{s}_{t-1} + Vh_{i} + b\right)$</center>
