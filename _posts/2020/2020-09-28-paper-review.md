...
3. <span style="color:red">2×2 Max-polling Layer (Stride 2)</span>
...
1. <span style="color:green">2×2 Deconvolution layer (Stride 2)</span>
...
3. <span style="color:blue">3×3 Convolution Layer + ReLu + BatchNorm (No Padding, Stride 1)</span>
4. <span style="color:blue">3×3 Convolution Layer + ReLu + BatchNorm (No Padding, Stride 1)</span>
